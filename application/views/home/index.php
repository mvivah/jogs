...
?>
  ...
  <div class="container" style="margin-top: 4rem;">
    ...
    <div class="row">
        ...
        <form class="form-inline my-lg-0" name="jobpost" onsubmit="return false">
          <input class="form-control mr-sm-2" type="text" name="newjob" placeholder="Enter a new job position" autocomplete="off">
          <button class="btn btn-outline-danger my-sm-0" type="button" onclick="check1()">START</button>
        </form>
      <?php endif;?>
  </div>
  </div>
        ...
        <table class="table table-bordered">
              <tr>
                <tr>
                  ...
                  <div class="testpos">Depth and range of technical know how <span class="fa fa-arrow-down"></span></div>
                  <div class = "bread text-right"> Human Relations Skills <span class="fa fa-arrow-right"></div>
                  </td>
    ...
    <table class="table table-bordered">
        <tr>
          <tr>
            ...
            <th colspan="4" rowspan = "2" scope="colgroup" style="width: 100px;  background:#e98f8e">
            0. INDETERMINATE</th>
          </tr>
          <tr>
